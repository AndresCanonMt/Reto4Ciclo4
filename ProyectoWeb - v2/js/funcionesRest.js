...
function mostrarTabla(items){
        ...
        for(i=0;i<items.length;i++){
                ...
                tableClient+="<td> <button onclick='clearItem("+items[i].idClient+")'>Borrar</button>";
                tableClient+="<td> <button onclick='itemByID("+items[i].idClient+")'>Editar</button>";
                tableClient+="</tr>";
        }
        tableClient+="</table>";
        ...
        for(i=0;i<items.length;i++){
                ...
                if(items[i].cars.length>0){
                        for(j=0;j<items[i].cars.length;j++){
                                ...
                                tableGama+="<td> <button onclick='itemByIdGama("+items[i].idGama+")'>Editar</button></td>";
                                tableGama+="</tr>";
                        }
                }else{
                        for(j=0;j<1;j++){
...
function mostrarTablaScore(items){
        ...
        for(i=0;i<items.length;i++){
                ...
                tableScore+="<td> <button onclick='clearItemScore("+items[i].idScore+")'>Borrar</button>";
                tableScore+="<td> <button onclick='itemByIdScore("+items[i].idScore+")'>Editar</button></td>";  
        }
        tableScore+="</table>";
